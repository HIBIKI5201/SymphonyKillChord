...
namespace DevelopProducts.Boss
{
    ...
    public class BossMoveView : MonoBehaviour, IGameplayControllable
    {
        ...
        [SerializeField] private ParticleSystem _attackHitEffectPrefab;
        [SerializeField] private ParticleSystem _attackReserveEffectPrefab;
