...
{
    public sealed class BitonicPixelSortingFeatureMod : ScriptableRendererFeature
    {
        [SerializeField] public ComputeShader shader;
        [SerializeField] public bool direction = true;
        [SerializeField] public bool ascending = true;
        [SerializeField][Range(0f, 1f)] public float thresholdMin = 0.4f;
        [SerializeField][Range(0f, 1f)] public float thresholdMax = 0.6f;
