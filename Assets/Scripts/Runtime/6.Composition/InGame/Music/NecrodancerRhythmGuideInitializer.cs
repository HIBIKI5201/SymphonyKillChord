...
namespace KillChord.Runtime.Composition.InGame.Music
{
    ...
    public class NecrodancerRhythmGuideInitializer : MonoBehaviour
    {
        /// <summary>
        ///     リズムガイド機能を初期化する。
        /// </summary>
        public void Initialize()
        {
            ...
            NecrodancerRhythmGuideViewModel viewModel = new NecrodancerRhythmGuideViewModel(_rhythmGuideView, presenter);
        }

        [Tooltip("リズムガイド定義アセット。")]
        [SerializeField] private RhythmGuideDefinitionAsset _rhythmGuideDefinitionAsset;
        [Tooltip("リズムガイドView。")]
        [SerializeField] private NecrodancerRhythmGuideView _rhythmGuideView;
    }
}
