...
{
    public sealed class BPMRhythmGuideInitializer : MonoBehaviour
    {
        /// <summary>
        ///     リズムガイド機能を初期化する。
        /// </summary>
        public void Initialize()
        {
            ...
            BPMRhythmGuideViewModel viewModel = new BPMRhythmGuideViewModel(_rhythmGuideView, presenter);
        }

        [Tooltip("リズムガイド定義アセット。")]
        [SerializeField] private RhythmGuideDefinitionAsset _rhythmGuideDefinitionAsset;
        [Tooltip("リズムガイドView。")]
        [SerializeField] private BPMRhythmGuideView _rhythmGuideView;
