...
namespace KillChord.Runtime.View.InGame.Skill
{
    ...
    public sealed class SkillGuideProgressView : MonoBehaviour, ISkillInputProgressRowView
    {
        ...
        private void RefreshIconPosition(int index)
        {
            ...
            if (!_rhythmGuideView.TryGetJustTimingRange(
                    setting.BeatType,
                    out float xPosition,
            ...
            UpdateInputRange(_leftInputRangeImage, -xPosition, inputRangeWidth, setting.BeatType);
            UpdateInputRange(_rightInputRangeImage, xPosition, inputRangeWidth, setting.BeatType);
