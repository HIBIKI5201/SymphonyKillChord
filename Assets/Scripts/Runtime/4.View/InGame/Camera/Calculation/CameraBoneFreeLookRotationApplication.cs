...
namespace KillChord.Runtime.View.InGame.Camera
{
    ...
    public sealed class CameraBoneFreeLookRotationApplication
    {
        ...
        public CameraBoneFreeLookRotationApplication(CameraViewParameter parameter)
        {
        ...
        public void Update(ref Quaternion cameraBoneRotation, in CameraCalculationContext context)
        {
        ...
        private readonly CameraViewParameter _parameter;
    }
}
