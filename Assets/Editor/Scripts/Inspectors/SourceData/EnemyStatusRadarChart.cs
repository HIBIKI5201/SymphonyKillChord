...
namespace KillChord.Editor.Inspectors.SourceData
{
    ...
    /// </summary>
    internal static class EnemyStatusRadarChart
    {
        /// <summary>
        ///     SerializedObjectから敵ステータスのレーダーグラフを描画します。
        /// </summary>
        /// <param name="serializedObject"> 敵キャラクターのSerializedObjectです。 </param>
        public static void Draw(SerializedObject serializedObject)
        {
            List<Metric> metrics = BuildMetrics(serializedObject);
        ...
        /// <summary>
        ///     SerializedObjectからグラフ指標を構築します。
        /// </summary>
        /// <param name="serializedObject"> 敵キャラクターのSerializedObjectです。 </param>
        /// <returns> グラフ指標一覧です。 </returns>
        private static List<Metric> BuildMetrics(SerializedObject serializedObject)
        {
