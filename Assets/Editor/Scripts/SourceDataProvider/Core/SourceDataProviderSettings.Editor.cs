    ...
    internal sealed class SourceDataProviderSettings : ScriptableSingleton<SourceDataProviderSettings>
    {
        ...
        private static List<RepositoryMapping> CreateDefaultMappings()
        {
            ...
            return new List<RepositoryMapping>
            {
                ...
                new("SkillNode", "SkillNodeDataRepository", "SkillNodes"),
                new("SkillNodeBind", "SkillNodeBindRepository", "SkillNodeBinds"),
                new("SkillNodePhaseBind", "SkillNodePhaseBindDataRepository", "PhaseBindData"),
                ...
                new("BossAttackEntry", "BossAttackEntryRepository", "_attackEntries"),
