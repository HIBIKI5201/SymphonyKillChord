...
#### キルコードの効果
自身の体力を一定割合（HealthCostRatio）消費して、その消費量に応じたダメージ（威力 DamageMultiplier）を与える。
...
- 正本: `Assets/Level/Data/Master/Skill/Templates/SkillData05.asset` の `_effectParameters`
