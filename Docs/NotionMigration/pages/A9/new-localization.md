...
- 整合性:
  ...
  - 用語リスト（27d7c2c6-cc02-813b-a93f-e6baf4d4f679）の「英名」が英訳の元になっている（#1667 の本文「Notion 用語集の英名を踏まえて作成」）。一方で「解放ポイント／研究ポイント」は 1 語扱いのままで、英語テーブルの仮訳の原因になっている（OG-215）
...
- 要確認:
  ...
  - 英語テーブルに日本語が残っている 5 キーの英訳（要企画確認。「解放ポイント／研究ポイント」の用語統一 OG-215 と同時に決める）
...
【要確認: 5項目の英訳を企画に確認。「解放ポイント」と「研究ポイント」のどちらに揃えるかと一緒に決める】
