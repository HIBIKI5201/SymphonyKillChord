...
- id: 39e7c2c6-cc02-8009-8530-cc10a4396fa5
- path: Symphony Kill Chord / システム概要 / シーンマネージャー
- last_edited: 2026-08-24T13:51:08.206Z
...
| `**LoadingTipsConfig**` | View | ロード画面に表示するTips文言を保持するScriptableObject。`GetRandomTip()`でランダムに1件返す |
