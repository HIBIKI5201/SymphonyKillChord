...
- id: 3bf7c2c6-cc02-819c-a123-d2d22318d23b
- path: Symphony Kill Chord / システム概要 / 状態効果（バフ・デバフ）
- last_edited: 2026-08-17T17:54:03.955Z

- 概要: インゲームの状態効果モジュール（旧バフシステム）
- カテゴリー: インゲーム
...
- 📄 [[① ダメージ計算への補正フロー]] (3bf7c2c6-cc02-81c7-a04c-c30f7ac31798)
- 📄 [[② 付与と期限切れのフロー]] (3bf7c2c6-cc02-81b4-a3d3-dd438788c33f)