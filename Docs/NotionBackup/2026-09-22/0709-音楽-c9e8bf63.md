...
- id: 3957c2c6-cc02-806b-9cc8-fbe9c9e8bf63
- path: Symphony Kill Chord / システム概要 / 音楽
- last_edited: 2026-08-24T13:55:02.966Z

- 概要: インゲームと常駐シーンの音楽システム
- カテゴリー: インゲーム
...
| `**UIToolkitSoundEffectBinder**` | View | `rootVisualElement`のUI Toolkitイベントを監視し、対応するUI操作音を解決して再生ポートへ渡す |
...
- 📄 [[① BGM 再生とリズム同期の更新フロー（毎フレーム）]] (3bf7c2c6-cc02-81fa-a314-c728299d6ede)
- 📄 [[② プレイヤー入力に対するジャスト判定フロー]] (3bf7c2c6-cc02-81c9-8bc6-ea98fd68d791)
- 📄 [[③ リズムアクション予約フロー（Enemy 等の外部モジュールから）]] (3bf7c2c6-cc02-8125-a337-cc26fa0cbb3f)