...
- 追加の人間からの指示「Github規定に従ってPRまでやって」を受け、pushとdevelop向けPR作成まで進める。Unity起動、PlayMode、テスト、mergeは実施しない。
- PRテンプレートのコンパイル・PlayMode必須確認は未完了のため、Draftとして作成し、レビュー提出前の残件として明記する。
